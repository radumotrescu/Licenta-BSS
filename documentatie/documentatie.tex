...
Se poate observa cum nu se poate distinge diferenta dintre semnalele initiale, desi se pot observa asemanari cu acestea, precum varfurile ascutite ale semnalului de tip fierastrau. 
...
Urmatorul test a fost efectuat cu doua semnale audio preluate de pe disc. Un semnal continea muzica, si un semnal continea o voce de barbat care spunea cifrele in engleza. Matricea de amestecare $A$ a fost:
\[
 \begin{matrix}
...
\begin{center}
 ...
 Urmatorul este a fost efectuat cu doua semnale audio, ambele contineau voci de barbat, unul spunea cifrele in engleza, iar celalalt spunea cifrele in spaniola. Matricea de amestecare $A$ este: 
\[
 \begin{matrix}
...
\begin{center}
 ...
 Urmatorul test a fost realizat cu trei semnale audio: un aspirator in functiune, o serie de aplaude si o voce. Acest test a fost facut pentru a demonstra faptul ca ICA poate separa mai mult de doua surse independente. 
