...
\subsection{Ce este PCA?\cite{data_reduction}}
...
\subsection{Ce este ICA? \cite{hyvarien}}
...
\subsection{Limitarile ICA \cite{hyvarien}}
...
\subsection{Independenta \cite{hyvarien}}
...
\subsubsection{Variabile nongaussiene \cite{hyvarien}}
...
\begin{center}
 ...
 \subsection{Principiile estimarii ICA \cite{hyvarien}}
...
\newpage
\subsection{Masuratori ale nongaussianitatii \cite{hyvarien}}
...
\newpage
\subsection{Abordarea Maximum Likelihood \cite{hyvarien}}
...
\begin{itemize}
	...
	\item{Trei semnale: acesta a fost testul care demonstra faptul ca se pot separa mai mult de doua componente independente amestecate, asa cum era ipoteza in teorie. Semnalele alese au fost cele reprezentand un aspirator in functiune, un voce umana, si un grup de oameni ce aplauda.\cite{vsubhashini}}
\end{itemize}
...
\subsection{Aplicatii ale ICA \cite{hyvarien}} 
